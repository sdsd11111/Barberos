...
import EscenaSlider from "@/components/landing/EscenaSlider";
...
export const metadata: Metadata = {
  ...
  description:
    "La mayoría de barberos administra su negocio a ciegas. BarberOS es el sistema de fidelización por WhatsApp para dejar de adivinar tus ingresos.",
  openGraph: {
  ...
  alternates: { canonical: "https://barberosplus.com" },
